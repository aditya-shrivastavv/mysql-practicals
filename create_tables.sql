...
create table sales_order01 (order_no varchar(6) PRIMARY KEY, order_date date, client_no varchar(6), dely_addr varchar(25), salesman_no varchar(6), dely_type char (1) default 'F',billed_yn char(1), dely_date date, order_status varchar(10), FOREIGN KEY (salesman_no) REFERENCES salesman_master01 (salesman_no), FOREIGN KEY (client_no) REFERENCES client_master01 (client_no));
